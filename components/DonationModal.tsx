            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2 text-center border-t border-slate-100">
                <a
                  href="/donate"
                  onClick={onClose}
                  className="text-xs font-bold text-amber-600 hover:underline flex items-center justify-center space-x-1"
                >
                  <span>Or Donate in Nigerian Naira (₦) via Providus Bank</span>
